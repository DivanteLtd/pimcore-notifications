 ...
 */
pimcore.registerNS("pimcore.plugin.notifications.panel");
pimcore.plugin.notifications.panel = Class.create({
                ...
                items: [
                    {
                        ...
                        handler: function (grid, rowIndex) {
                            pimcore.plugin.notifications.helpers.openDetails(grid.getStore().getAt(rowIndex).get("id"), function() {
                                this.reload();
                            }.bind(this));
                        }.bind(this)
                    },
